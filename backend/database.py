...
POSTGRES_ALTER_STATEMENTS = [
    ...
    # FH / manager workflow columns (present in the SQLite ALTER list but were missing here)
    "ALTER TABLE nomination_requests ADD COLUMN IF NOT EXISTS fh_id TEXT",
    "ALTER TABLE nomination_requests ADD COLUMN IF NOT EXISTS fh_name TEXT",
    "ALTER TABLE nomination_requests ADD COLUMN IF NOT EXISTS requested_by_fh INTEGER DEFAULT 0",
    "ALTER TABLE nomination_requests ADD COLUMN IF NOT EXISTS seen_by_manager INTEGER DEFAULT 0",
    "ALTER TABLE course_requests ADD COLUMN IF NOT EXISTS fh_id TEXT",
    "ALTER TABLE course_requests ADD COLUMN IF NOT EXISTS fh_name TEXT",
    "ALTER TABLE course_requests ADD COLUMN IF NOT EXISTS requested_by_fh INTEGER DEFAULT 0",
    "ALTER TABLE course_requests ADD COLUMN IF NOT EXISTS seen_by_manager INTEGER DEFAULT 0",
    "ALTER TABLE trainings ADD COLUMN IF NOT EXISTS trainer_name TEXT",
    "ALTER TABLE trainings ADD COLUMN IF NOT EXISTS batches TEXT",
    "ALTER TABLE trainings ADD COLUMN IF NOT EXISTS source_request_id TEXT DEFAULT ''",
    ...
    # Tables that the SQLite path creates in its ALTER list — must also exist on Postgres.
    """CREATE TABLE IF NOT EXISTS course_request_participants (
        id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        request_id TEXT,
        employee_id TEXT,
